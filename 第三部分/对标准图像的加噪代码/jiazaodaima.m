...
% 读取图像（如果是彩色则转换为灰度）
img = imread('C:\Users\HUAWEI\Desktop\第三部分\灰色图像分析图\原始图像\原始图像10.png');
if size(img, 3) == 3
    img = rgb2gray(img);
end

% 设置参数
noise_fraction = 7.5/100;    % 添加 30% 像素的噪声
sigma = 250;              % 噪声标准差
...
save_folder = 'C:\Users\HUAWEI\Desktop\第三部分\灰色图像分析图\处理图像\';
save_filename = '处理图像10.png';
